      ...
      function getSeconds() {
        ...
        var diff = parseInt((atime - curtime)/1000);
         if (diff > 0) { 
         	...
         	console.log("test");
         	document.getElementById("clock-description").style.display = "block";
         	document.getElementById("hours").style.display = "block";
         	document.getElementById("minutes").style.display = "block";
         	document.getElementById("seconds").style.display = "block";
         	document.getElementById("clock-hours").style.display = "inline-block";
         	document.getElementById("clock-minutes").style.display = "inline-block";
         	document.getElementById("clock-seconds").style.display = "inline-block";

         	document.getElementById("cutt-off-message").style.display = "none";
         }
         else { 
         	curday = dy - nowDate.getDay() -1;
         	console.log("test2"); 
         	document.getElementById("clock-description").style.display = "none";
         	document.getElementById("hours").style.display = "none";
         	document.getElementById("minutes").style.display = "none";
         	document.getElementById("seconds").style.display = "none";
         	document.getElementById("clock-hours").style.display = "none";
         	document.getElementById("clock-minutes").style.display = "none";
         	document.getElementById("clock-seconds").style.display = "none";

         	document.getElementById("cutt-off-message").style.display = "block";
...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			...
			?>
			<div class="logo_float_left">
				<div class="cutt-off-count-down">
					<div id="countholder">
						<p id="clock-description" style="font-size:15px;"> Time Left for Same Day Delivery</p>
				       <div class="clock-number" id="clock-hours" ><span class="hours" id="hours"></span><div class="smalltext">Hours</div></div>
				       <div class="clock-number" id="clock-minutes"><span class="minutes" id="minutes"></span><div class="smalltext">Minutes</div></div>
				       <div class="clock-number" id="clock-seconds"><span class="seconds" id="seconds"></span><div class="smalltext">Seconds</div></div>
				    	<div id="cutt-off-message">
				            <p> Need It Tomorrow? </p>
				            <p> "Order anytime for Next Day Delivery </p>
				        </div>
				    </div>
				</div>	
			</div>

			<div class="logo_float_right">
			<?php if ( $et_contact_info_defined ) : ?>
				<div id="et-info">
				<?php if ( '' !== ( $et_phone_number = et_get_option( 'phone_number' ) ) ) : ?>
					<p><span id="et-info-phone"><?php echo et_core_esc_previously( et_sanitize_html_input_text( $et_phone_number ) ); ?></span></p>
				<?php endif; ?>

				<?php if ( '' !== ( $et_email = et_get_option( 'header_email' ) ) ) : ?>
					<p><a href="https://mail.google.com/mail/?view=cm&fs=1&to=orders@mabuhayflowers.com" class="mb-mail"><span id="et-info-email"><?php echo esc_html( $et_email ); ?></span></a></p>
				<?php endif; ?>
